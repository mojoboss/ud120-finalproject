...
features_list = ['poi', 'salary', 'to_messages', 'deferral_payments', 'total_payments',
                 ...
                 'long_term_incentive', 'restricted_stock'] # You will need to use more features
...
clf = tree.DecisionTreeClassifier(min_samples_split=42, criterion = 'entropy')    # Provided to give you a starting point. Try a varity of classifiers.

'''
from sklearn.svm import SVC
c=10000.0 # this value is tuned, large c is giving more accuracy,tried c=10, c = 100, 1000 etc
